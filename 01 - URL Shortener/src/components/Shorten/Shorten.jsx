        ...
        <div className="mx-auto max-w-[1300px] -translate-y-20">
            <div className=" p-10 mt-36 h-[160px] bg-[#3b3054] bg-shorten-pattern bg-cover rounded-lg ">
                <form className="flex items-center h-[100%]" onSubmit={handleSubmit}>
                    ...
                    />
                    <button
                        className=" ml-6 rounded-lg w-[200px] text-white tracking-wide h-[50px] bg-cyan-500 hover:bg-cyan-600 active:opacity-80">
                        Shorten It
                    </button>
                </form>
                {active ? (
            ...
            {shortenLink.map((shortLink) => (
              ...
              <span className="font-bold text-cyan-500">
                {shortLink.shortLink}
                            ...
                            <button className="bg-cyan-500 py-2 rounded-md px-6 text-white copy" onClick={() => {
